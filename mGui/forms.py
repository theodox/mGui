...
class VerticalThreePane(Form):
    """
    First child is glued to the top, last child is glued to the bottom, intermediate childrend are stretched
    """
...
class HorizontalThreePane(Form):
    """
    First child is glued to the left, last child is glued to the right, intermediate childrend are stretched
    """
