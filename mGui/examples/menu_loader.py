...
def about(*_, **__):
    print(
        (
            cmds.confirmDialog(
                title="mGui",
                message="This is function was loaded from a yaml file",
                button="Wow!",
            )
        )
    )
...
def regular(*_, **__):
    print(
        (
            cmds.confirmDialog(
                title="mGui",
                message="Menus commands can be loaded as fully qualified path names, "
                "like <b>mGui.examples.menu_loader.regular</b>",
                button="Cool!",
            )
        )
    )
