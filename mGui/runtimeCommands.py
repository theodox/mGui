...
def create_proxy_command(callable_object, *args, **kwargs):
    ...
    """
    comment = "# autogenerated callback for %s" % callable_object.__module__ + '.' + callable_object.__name__
    source_mod = callable_object.__module__
    import_line = ''
    if source_mod != '__builtin__':
        import_line = "from %s import %s" % (source_mod, callable_object.__name__)
    ...
    fn = "%s(%s)\n" % (callable_object.__name__, arguments)
